...
|            |                | Mortgagee                                                    | In this Dropdown, Show only those Banking whose type is `Mortgage fixed rate`. These Banking must be in that family. Banking alphabetical sorting. |
|            | Policy Limits  |                                                              |                                                              |
|            |                | Dwelling                                                     | Dropdown. Values are `Yes- $` or `Yes- % ` or `No`. Default value is `No`. If the user selects `Yes- $`, an amount field is created. This amount field is number input field and decimal is not allowed. default value is `$ 0`. if the user selects `Yes- %`, a field is created. This field is Percentage input field. default value is `0.00 %`. |
...
|            |                | Equipment Breakdown Deductible                               | This field will only appear if the value of `Equipment Breakdown` is set to `Yes- $`or `Yes- %`.<br />There is show one dropdown and one field. values are : `$` or `%`. default value is `$ 0`. If the user selects `%`, then filed is allowed percentage input field. default value is `0.00 %`. |
...
|            |                | Loss Assessment                                              | Dropdown. Values are `Yes- $` or `Yes- % ` or `No`. Default value is `No`. If the user selects `Yes- $`, an amount field is created. This amount field is number input field and decimal is not allowed. default value is `$ 0`. if the user selects `Yes- %`, a field is created. This field is Percentage input field. default value is `0.00 %`. |
|            |                | Deductible                                                   | There is show one dropdown and one field. values are : `$` or `%`. default value is `$ 0`. If the user selects `%`, then filed is allowed percentage input field. default value is `0.00 %`. |
...
| Automobile |                |                                                              |                                                              |
|            | Policy Details |                                                              |                                                              |
|            |                | Vehicles Covered                                             | Multivalue field. In this Dropdown, Show only those assets whose asset type is `Automobile`. These assets must be in that family. Assets are alphabetical sorting. |
|            | Policy Limits  |                                                              |                                                              |
|            |                |                                                              |                                                              |
|            |                |                                                              |                                                              |
|            |                |                                                              |                                                              |
