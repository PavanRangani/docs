...
Category of the project. It can be one of the:  `Arts and Culture`, `Donor Advised Fund`,  `Education`,  `Environment`, `General`, `Global`,  `Health` , ` Human Services`, `Public Policy`, `Private Foundation`, `Religion`.
