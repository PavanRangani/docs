...
|                             | EIN (*)                                   | EIN number of the trust.  Mandatory for Non Grantor trusts. For Grantor trust its optional. |                                                         |
...
- CURRENT tab
  ...
  - Columns under Amendment section: Amendment number, Date range, Purpose
- HISTORY tab
...
- Table of Amendement section and History page
  - Columns: Amendment number, Date range, Purpose
  ...
  - Date range shows duration for which that amendment was in effect. 
    - Suppose any trust has two amendments available.
    - First record will be `Initial version` . Its purpose will be blank always. Start date will be date of formation and end date will be `First Amendement date - 1 day`.
    - For first amendment it will show `First amendement date` as start date and `Second amendment date - 1 day` as end date. 
    - For second record it will show second amendment date as start date and `Today` as end date. 
