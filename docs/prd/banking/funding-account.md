...
|                         |                         | Entry                      | It's alphabetical sorted dropdown of those clarius user whose `Allow wire instruction second check` is true.                                                                                                                                                                                                                                                                                 |
...
|                         |                         | Fund                       | It is a mandatory field. It shows LPs of the selected asset manager.                                                                                                                                                                                                                                                                                                                         |
|                         |                         | Bank                       | It is disabled. It is pulled the `Bank` data from the wire instruction tab of the selected fund.                                                                                                                                                                                                                                                                                             |
|                         |                         | Account Number             | It is disabled. It is pulled the `Account Number` data from the wire instruction tab of the selected fund.                                                                                                                                                                                                                                                                                   |
|                         | SLOA Journal            |                            |                                                                                                                                                                                                                                                                                                                                                                                              |
|                         |                         | Nickname                   | It is a mandatory and free form text input field.                                                                                                                                                                                                                                                                                                                                            |
...
|                         |                         | Memo                       | It is a mandatory and free form text input field.                                                                                                                                                                                                                                                                                                                                            |
...
| Check Writing           | Details                 |                            | This section is applicable only when `Check Writing` section switch is ON.                                                                                                                                                                                                                                                                                                                   |
...
| Archive Details         |                         |                            |                                                                                                                                                                                                                                                                                                                                                                                              |
|                         |                         | Archived Date              | Applicable only when any SLOA is mark as archived. It is a mandatory and date input field.                                                                                                                                                                                                                                                                                                   |
...
- User manually change the order of SLOA. [See more details](#change-order-of-sloa)
...
## Change order of SLOA

### UX Rule
- Allow to manually sort the records under the `SLOA Wire (General)`, `SLOA Wire (Investments)`, `SLOA Journal`, `SLOA Check` & `SLOA Moneylink` sections.
...
### UI Rule
[Mockup](https://drive.google.com/file/d/1l1N46TSBfm0EwIVGGh3Kk5GvZBlfMXl4/view?usp=drive_link)
