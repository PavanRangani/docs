...
|                         |                         | Bank                       | It is disabled. It's pulled the `Receiving Bank Name` for `Internation Wire Instruction` or `Bank Name` for `Regular Wire Instruction` from the wire instruction tab of the selected fund.                                                                                                                                                                                                                                                                                             |
|                         |                         | Account Number             | It is disabled. It's pulled the `Account Number` of International or Regular Wire Instruciton from the wire instruction tab of the selected fund.                                                                                                                                                                                                                                                                                   |
|                         | SLOA Journal            |                            |                                                                                                                                                                                                                                                                                                                                                                                              |
|                         |                         | Nickname                   | It is a mandatory and free form text input field.                                                                                                                                                                                                                                                                                                                                            |
|                         |                         | Account Number             | It is a mandatory field. Allows only 4 numbers.                                                                                                                                                                                                                                                                                                                                               |
|                         | SLOA MoneyLink          |                            |                                                                                                                                                                                                                                                                                                               |
